...
def main(_):
  ...
  results = {'pos_ratio': sum(y) / len(y),
             ...
             'click/weighted_inv': weighted_inv_click}
  ...
  importants = ['auc', 'time_auc', 'weighted_time_auc', 'click/time_auc', 'click/weighted_time_auc', \
                'group/auc', 'group/time_auc', 'group/weighted_time_auc', 'group/top3_click_rate', \
                'group/click/time_auc', 'group/click/weighted_time_auc', 'group/click/top3_rate']
